...
import spacialReviewer from '../../CompanyApi/reviewer/spacialReviewer';
...
export default function ReviewerProfile() {
    ...
    useEffect(() => {
        // Fetch data from API
        const getSpecialreviewer = async (id) => {
          try {
            const response = await spacialReviewer(id);
